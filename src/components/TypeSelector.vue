  ...
  <div class="flex items-start gap-2 w-full">
    <div class="flex-1 min-w-0">
      ...
      <div class="relative w-auto">
        <select
          v-model="model"
          class="block bg-white w-full border border-slate-300 rounded-md
                 py-1.5 pl-3 pr-10 shadow-sm focus:outline-none
...
watch(
  ...
  (newVal) => {
    if ((model.value === null || model.value === '') && newVal.length) {
      model.value = 'all'
    }
  },
  { immediate: true }
