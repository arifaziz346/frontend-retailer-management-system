...
import { getStoragePath } from '@/utils/ImageUrl.js'
...
//    console.log('remove-src',getStoragePath(src))

   //Pass value to parent Products
   if(getStoragePath(src)!==null){
     console.log('Hi i am going to remove,',getStoragePath(src));
     emit('removeVariantImage',src)
