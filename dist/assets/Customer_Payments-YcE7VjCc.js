import{r as l,j as K,l as w,c as r,o as n,A as Q,k as D,m as W,a as t,b as v,u as X,h as U,t as i,e as z,F as Z,x as tt,q as M,i as et,f as k,y as A,w as st,v as ot}from"./index-UQaXpZ2x.js";import{a as P}from"./axios-CBe-jvwZ.js";import{_ as B}from"./BaseModal-B4RG3mEr.js";import{_ as F}from"./FormInput-ChiTm2_o.js";import{_ as at}from"./Pagination-7CBBNeUc.js";import{u as rt}from"./useAboutStore-D-Te-XBA.js";import{V as nt}from"./vue-spinner-tail-DEOVpcqI.js";import{t as S}from"./toast-BWxgGeSH.js";import{u as lt}from"./useFormErrors-BWkWHfi_.js";import{_ as it}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./stringHelpers-DhATn_QK.js";const dt={class:"hidden"},ut={__name:"PaymentPrint",setup(I,{expose:N}){const p=rt(),m=l(null);K(()=>{p.about&&(m.value=p.about)});const _=w(()=>p.about?.name||"-"),b=w(()=>p.about?.address||"-"),h=w(()=>p.about?.phone_number||"-"),x=w(()=>p.about?.additional_phone||"-");w(()=>p.about?.image_url||"-");const c=l(null),f=l("");return N({print:(y,d)=>{if(c.value=y,f.value=d,!c.value)return;const $=`
<html>
<head>
  <meta charset="UTF-8">
