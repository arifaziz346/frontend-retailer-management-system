import{u as y}from"./useAboutStore-BXM3Gzxh.js";import{r as n,i as $,k as i}from"./index-Bo1dTLXg.js";const w={__name:"SalePrint",props:{shopName:{type:String,default:""},shopAddress:{type:String,default:""},shopPhone:{type:String,default:""},logo:{type:String,default:null}},setup(r,{expose:c}){const e=y(),u=n(null);$(()=>{e.about&&(u.value=e.about),console.log("About in SalePrint --->",e.about?.phone_number)});const a=r,p=i(()=>a.shopName||e.about?.name||"My Shop"),h=i(()=>a.shopAddress||e.about?.address||"Shop Address"),v=i(()=>a.shopPhone||e.about?.phone_number||""),o=i(()=>a.shopPhone||e.about?.additional_phone||""),l=i(()=>a.logo||e.about?.image_url||""),t=n(null);return c({print:m=>{if(t.value=m,!t.value)return;const g=Array.isArray(t.value.items)&&t.value.items.length?t.value.items.map(s=>`
        <tr>
          <td>${s.name}</td>
    ...
    <body onload="window.print(); setTimeout(()=>window.close(), 500)">
      <div class="receipt">
        ${l.value?`<img src="${l.value}" class="logo"/>`:""}
        <h3>${p.value}</h3>
